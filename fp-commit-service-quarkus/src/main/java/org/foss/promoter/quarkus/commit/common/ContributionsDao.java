...
package org.foss.promoter.quarkus.commit.common;
...
public class ContributionsDao {
    ...
    private static final org.jboss.logging.Logger LOG = Logger.getLogger(ContributionsDao.class);
    ...
    public void createKeySpace() {
        ...
        LOG.infof("Executing %s", statement);
    ...
    public void createTable() {
        ...
        LOG.infof("Executing create table %s", statement);
    ...
    public void delete(UUID id) {
        ...
        session.execute(statement.getQuery(), id);
    }
}
